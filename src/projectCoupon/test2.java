		...
		CouponClientFacade facade;
			...
			//	adminFacad.updateCompany(company02, "tadiran", "444", "tadiran@walla.com");  // Update company HOLMESPLACEþ with password
				...
				if (facade instanceof CompanyFacade) {
					...
					//  Update Coupons
				    Coupon coupon04=new Coupon(3,"Deal-03", Utile.getCurrentDate(),Utile.getDateAfter(2), 10, couponType.food, "Best Deal", 77.99, "http//www.pizzahatCoupon.co.il/?3");
				...
				if (facade instanceof CompanyFacade) {
					...
					System.out.println("After creating 3 new HOLMESPLACE coupons-show all company coupons\n"+coupons.toString());
				...
				if (facade instanceof CompanyFacade) {
					...
					coupons = companyFacade.getCoupons();
					System.out.println("After creating 3 new BUG coupons - Show all company coupons\n" + coupons.toString());
					...
					System.out.println("View all BUG company Coupons by Max 100 days from today (Expiration Date= " + Utile.getDateAfter(100).toString() + "):\n" + coupons.toString());
	}
				...
				if (facade instanceof CompanyFacade) {
					...
					// Add new 3 coupons
					Coupon coupon01 = new Coupon(10,"deal-01",Utile.getCurrentDate(),Utile.getDateAfter(10),  2, couponType.Camping, "Deal Of The year-1",  35.00, "http//www.wallatours.co.il/?1"); 
					Coupon coupon02 = new Coupon(11,"deal-02",Utile.getCurrentDate(),Utile.getDateAfter(20), 3, couponType.Traveling, "Deal Of The year-1",  45.00, "http//www.wallatours.co.il/?2"); 
					Coupon coupon03 = new Coupon(12,"deal-03",Utile.getCurrentDate(),Utile.getDateAfter(30), 3, couponType.Camping, "Deal Of The year-1",  55.00, "http//www.wallatours.co.il/?3"); 
					...
					coupons = companyFacade.getCoupons();
					System.out.println("After creating 3 new wallaTours coupons - Show all company coupons\n" + coupons.toString());
					...
					// getCouponsByMaxCouponDate(100 days from today)
					coupons = companyFacade.getCouponsByMaxCouponDate(Utile.getDateAfter(100));
					System.out.println("View all wallaTours company Coupons by Max 100 days from today (Expiration Date= " + Utile.getDateAfter(100).toString() + "):\n" + coupons.toString());
				...
				if (facade instanceof CompanyFacade) {
					...
					coupons = companyFacade.getCoupons();
					System.out.println("After creating 3 new FOX coupons - Show all company coupons\n" + coupons.toString());
					...
					// getCouponsByMaxCouponDate(100 days from today)
					coupons = companyFacade.getCouponsByMaxCouponDate(Utile.getDateAfter(100));
					System.out.println("View all fox company Coupons by Max 100 days from today (Expiration Date= " + Utile.getDateAfter(100).toString() + "):\n" + coupons.toString());
	}
				...
				if (facade instanceof CustomerFacad) {
		         ...
		         CustomerFacad customerFacad=new CustomerFacad();
					...
					System.out.println("List of All Michal's Purchased Coupons by RESTURANTS type: \n" + coupons.toString());
					...
					System.out.println("List of All Michal's Purchased Coupons by max price of 80 nis: \n" + coupons.toString());
				...
				if (facade instanceof Customer) {
		         ...
		         CustomerFacad customerFacad=new CustomerFacad();
					...
					coupons = customerFacad.getAllPurchasedCouponsByPrice (80); 
					System.out.println("List of All Eli's Purchased Coupons by max price of 80 nis: \n" + coupons.toString());
				...
				if (facade instanceof Customer) {
		         ...
		         CustomerFacad customerFacad=new CustomerFacad();
					...
					coupons = customerFacad.getAllPurchasedCouponsByPrice (80); 
					System.out.println("List of All Hana's Purchased Coupons by max price of 80 nis: \n" + coupons.toString());
				...
				if (facade instanceof Customer) {
		         ...
		         CustomerFacad customerFacad=new CustomerFacad();
					...
					coupons = customerFacad.getAllPurchasedCouponsByPrice (80); 
					System.out.println("List of All Gila's Purchased Coupons by max price of 80 nis: \n" + coupons.toString());
